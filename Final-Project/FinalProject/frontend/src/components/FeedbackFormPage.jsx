  ...
  return (
    <div className="form-page">
      <header className="form-header">
        ...
        <p>Report issues or provide feedback about trains in Finland. Data is stored in the app database through the backend API.</p>
      </header>
      ...
      <div className="form-grid">
        ...
        <section className="response-card">
          <div className="response-card-header">
            ...
            <p>The response from your own API is shown here.</p>
          </div>
          ...
          {response ? (
            <div className="response-body">
              <div className="response-summary">
                <div>
                  <strong>Stored feedback ID:</strong>
            ...
            <p className="empty-state">Submit the form to save feedback in the database.</p>
          )}
        </section>
      </div>
